...
hist(df$GRE.Score, main = "GRE Á¡?? ???????×·?", xlab = "GRE Á¡??", col = "skyblue")
hist(df$TOEFL.Score, main = "TOEFL Á¡?? ???????×·?", xlab = "TOEFL Á¡??", col = "green")
hist(df$SOP, main = "SOP Á¡?? ???????×·?", xlab = "SOP Á¡??", col = "orange")
hist(df$CGPA, main = "CGPA Á¡?? ???????×·?", xlab = "CGPA Á¡??", col = "darkmagenta")
hist(df$LOR, main = "LOR Á¡?? ???????×·?", xlab = "LOR Á¡??", col = "yellow")
hist(df$Chance.of.Admit, main = "CoA ???????×·?", xlab = "CoA", col = "red")

# ?Ã°?È­(boxplot)
par(mfrow = c(2, 3), mar = c(2, 4.1, 4.1, 2.1))
boxplot(df$GRE.Score, main = "GRE Á¡?? ???????×·?", xlab = "GRE Á¡??", col = "skyblue")
boxplot(df$TOEFL.Score, main = "TOEFL Á¡?? ???????×·?", xlab = "TOEFL Á¡??", col = "green")
boxplot(df$SOP, main = "SOP Á¡?? ???????×·?", xlab = "SOP Á¡??", col = "orange")
boxplot(df$CGPA, main = "CGPA Á¡?? ???????×·?", xlab = "CGPA Á¡??", col = "darkmagenta")
boxplot(df$LOR, main = "LOR Á¡?? ???????×·?", xlab = "LOR Á¡??", col = "yellow")
boxplot(df$Chance.of.Admit, main = "CoA ???????×·?", xlab = "CoA", col = "red")
...
hist(df$Chance.of.Admit, main = "???Ð¿? ?Õ°? È®??", xlab = "???Ð¿? ?Õ°? È®??", col = "red")
boxplot(df$Chance.of.Admit, main = "???Ð¿? ?Õ°? È®??", xlab = "???Ð¿? ?Õ°? È®??", col = "red")
